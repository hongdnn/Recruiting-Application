...
export default {
  ...
  methods: {
    ...
    showDetail(interview_id) {
      this.$router.push({
        path: "./interview-detail-for-collaborator?id=" + interview_id,
      });
    },
  },
};
...
<template>
  <Layout>
    <div class="mat-interview-collab">
      <div class="d-flex">
        <i
      ...
      <div class="list-candidates mt-2">
        <div class="header">
          <div class="form">
            <form class="filter position-relative" action="">
              <!-- Search bar -->
              <div class="filter-search-interview mb-3">
                <div class="row">
                  <div class="col-12 mat-search-interview">
                    <div class="inputSearch col-xs-12 col-md-10 col-sm-9">
                    ...
                    <div
                      class="
                        handleActionSearch-collab
                        col-xs-12 col-md-2 col-sm-3
                      "
                    >
                      <button
                        type="button"
                        class="btn btn-search-collab"
              ...
              >
                <div
                  class="d-flex align-items-center flex-wrap filter-bar-interview__filter"
                >
                  <span style="margin-right: 10px" class="textSort"
                    ><i
                      class="fas fa-filter"
                  ...
                  <div class="filterSelect">
                    ...
                    <div class="optionSelected">
                      <div class="mat-filter-text">
                        <span class="mat-title-filter"> Tình trạng </span>
                      </div>
                      <multiselect
                        @input="inputStatus"
                ...
                <div class="d-flex sort align-items-center flex-wrap filter-bar-interview__sort">
            ...
            <table class="table">
              <thead>
                <tr style="border: 1px solid #eae9e9; background: #f1f1f1">
                  ...
                  <th class="mat-title-table" scope="col">Ghi chú phỏng vấn</th>
                </tr>
              </thead>
              <tbody
                class=""
...
.mat-interview-collab {
  ...
  .handleActionSearch-collab .btn-search-collab:hover {
...
.status {
  ...
  .filter-bar__interview .form-control,
  ...
  .filter .filter-bar__interview input {
    font-size: 14px;
    padding-right: 0;
    padding-left: 0;
    width: 200px;
  ...
  .filter-search-interview input {
    border: none;
    padding: 0 0 !important;
  }
  .filter-search-interview .inputSearch i {
    display: inherit;
    justify-content: center;
    padding: 0 5px;
    margin-left: 10px;
  }
  .filter-search-interview .inputSearch {
    display: flex;
    align-items: center;
  ...
  .filter-search-interview button {
    width: 100% !important;
  }

  .filter-search-interview i[class^="fa"] {
    top: 20px;
    left: 10px;
  }
