...
export default {
  page: {
    title: "Thêm lịch sử giới thiệu ứng viên",
    meta: [
      {
        name: "description",
    ...
    this.unsub = this.$store.subscribe((mut, state) => {
      switch (mut.type) {
        ...
        case "candidates/updateCandidateSuccess":
          this.referCandidateForPost();
          break;
        case "candidates/updateCandidateFailure":
          Swal.fire({
            title: "Xác nhận tiếp tục giới thiệu ứng viên",
            text: "Ứng viên không thể cập nhật thông tin do đang được giới thiệu cho công việc khác. Bạn đồng ý giới thiệu ứng viên mà không cần cập nhật thông tin không?",
            icon: "question",
        ...
        case "candidates/createCandidateSuccess":
          this.referCandidateForPost(state.candidates.createCandidateData.id);
          break;
        case "candidates/referCandidateSuccess":
          Swal.fire("Giới thiệu ứng viên thành công", "", "success").then(
            () => {
              const introduction_id =
                state.candidates.referCandidateData.candidateIntroductionId;
              this.$router.push({
                path:
                  "/refer-candidate-detail-collaborator?id=" + introduction_id,
              });
            }
          );
          break;
        case "candidates/referCandidateFailure":
          Swal.fire("Giới thiệu ứng viên không thành công", "", "error").then(
            () => {}
          );
          break;
      }
  ...
  methods: {
    ...
    fillCandidateDetail() {
      ...
      if (this.$store.state.candidates.cvPath) {
        this.cv_path = this.$store.state.candidates.cvPath;
      }
      ...
      this.form.lowestSalary = this.candidate_detail.salary_from;
      this.form.highestSalary = this.candidate_detail.salary_to;
    ...
    createCandidate() {
      ...
      const path_cv_hided = this.$store.state.candidates.cvPath;
    ...
    updateCandidateDetail() {
      Swal.fire({
        title: "Xác nhận giới thiệu ứng viên",
        icon: "question",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
    ...
    //Refer candidate
    referCandidateForPost(candidate_id) {
      var warrantyId = null;
        ...
        <div class="tool-bar row">
          <div class="col-md-12 title d-flex align-items-center">
            ...
            <div class="titleCreate">
              <span
                >Giới thiệu ứng viên cho công việc</span
              >
            </div>
          </div>
        </div>
              ...
              <div class="formCreated">
                    ...
                    <div class="col-6" style="padding-left: 10px">
                      ...
                      <div class="">
                        <multiselect
                          ...
                          :allow-empty="false"
                          :class="{
                            'is-invalid': submitted && $v.form.areaWork.$error,
                          }"
                        >
                        </multiselect>
                        <!-- <multiselect
                ...
                <div class="formCreatedContent" style="margin-top: 30x">
                  <div class="col-12 formCreateGroup">
                    ...
                    <div>
                      <span
                        v-if="form.lowestSalary > form.highestSalary"
                        class="text-danger"
                  ...
                  <div class="col-12 formCreateGroup">
                    <label for=""
                      >Tại sao ứng viên thay đổi công việc và kỳ vọng của cô ấy
                      / anh ấy là gì?<span class="labelStar">*</span></label
                    >
                    <div class="inputForm">
                      <textarea
                        id="w3review"
                          ...
                          <div class="col-6" style="padding-right: 10px">
                            ...
                            <div class="inputForm">
                              <input
                                ...
                                placeholder="Nhập số năm"
                                v-model="
                                  candidate_languages[index].year_of_experience
                                "
                              />
                            </div>
                          </div>
                          <div class="col-6" style="padding-left: 10px">
                            ...
                            <div class="inputForm">
                              <input
                                ...
                                v-model="candidate_languages[index].your_rating"
                              />
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-6" style="padding-right: 10px">
                            ...
                            <div class="inputForm">
                              <input
                                ...
                                v-model="candidate_experiences[index].job_title"
                              />
                            </div>
                          </div>
                          <div class="col-6" style="padding-left: 10px">
                ...
                <div class="formCreatedContent">
                  <div class="formCreateGroup">
                    ...
                    >
                      ...
                      <div v-if="optional_field.type === 'multiselect'">
                        <multiselect
                          v-model="optional_field.value"
                          :options="getOptionList(optional_field.data)"
                          :multiple="true"
                          :close-on-select="false"
                          :clear-on-select="false"
                          :preserve-search="true"
                      ...
                      <div v-if="optional_field.type === 'dropdownlist'">
                        <multiselect
                          v-model="optional_field.value"
                          :options="getOptionList(optional_field.data)"
                          :placeholder="optional_field.hint"
              ...
              <div class="actionHandleForm d-flex">
                ...
                <div class="actionHandle">
                  <button type="submit" class="btnSave">
                    <i class="fas fa-save"></i>Gửi ứng viên
                  </button>
                </div>
              </div>
            </div>
