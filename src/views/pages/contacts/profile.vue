...
export default {
  ...
  computed: {
    ...
    // },
    ...mapGetters("user", [
      "getProfileCollabGetter",
      "getIndustryForCollabGetter",
      "getJobRolesGetter",
      "getSkillsGetter",
      "getLanguagesGetter",
      "getCityGetter",
    ...
    dataProfile() {
      return this.getProfileCollabGetter;
    },
    dataIndustry() {
      return this.getIndustryForCollabGetter;
    },
    dataJobRole() {
  ...
  created() {
    this.unsub = this.$store.subscribe((mut, state) => {
      switch (mut.type) {
        case "user/industryForCollabSuccess": {
          this.allIndustries = state.user.industry_collab_data.industries;
          break;
        }
        case "user/jobRoleSuccess": {
          this.allJobRoles = state.user.job_role_data.job_role;
          break;
        }
        case "user/skillSuccess": {
          this.allSkills = state.user.skill_data.skills;
          break;
        }
        case "user/citySuccess": {
          this.allCities = state.user.city_data.cities;
          break;
        }
        case "user/languageSuccess": {
          this.allLanguages = state.user.language_data.languages;
          break;
        }
  ...
  mounted() {
    ...
    this.getLanguage();
    this.getCity();
    this.getIndustryForCollaborator();
  ...
  methods: {
    ...mapActions("user", [
      ...
      "putProfileByCollaborator",
      "putBankAccount",
      "uploadBankImg",
      "changePassword",
      "getIndustryForCollaborator",
    ...
    async getProfileByCollaboratorId() {
      ...
      this.user.first_name = this.userCollab.data.first_name;
      this.user.email = this.userCollab.data.email;
      this.user.phone = this.userCollab.data.phone;
      this.user.date_of_birth_update = this.userCollab.data.birth_day;
      if (this.userCollab.data.birth_day !== null) {
        this.user.date_of_birth_read = moment(
          this.userCollab.data.birth_day
        ).format("DD/MM/YYYY");
      }
      this.user.last_name = this.userCollab.data.last_name;
      this.user.image = this.userCollab.data.image;
      if (this.user.image !== null) {
        this.existedImage = process.env.VUE_APP_API_URL + this.user.image.path;
      }
      this.user.address = this.userCollab.data.address;
      this.user.status = this.userCollab.data.status;
      this.user.job_roles = this.userCollab.data.job_roles;
      if (this.userCollab.data.job_levels !== null) {
        this.user.job_levels = this.userCollab.data.job_levels.split(";");
      }
      this.user.candidate_skills = this.userCollab.data.candidate_skills;
      this.user.industries = this.userCollab.data.job_industries;
      if (this.userCollab.data.bank_account !== null) {
        this.user.id_number = this.userCollab.data.bank_account.id_number;
        this.user.bank_id = this.userCollab.data.bank_account._id;
        this.user.proficient_languages =
          this.userCollab.data.proficient_languages;
        this.user.bank_account_fullname =
          this.userCollab.data.bank_account.bank_account_fullname;
        this.user.bank_account_name =
          this.userCollab.data.bank_account.bank_name;
        this.user.issued_location =
          this.userCollab.data.bank_account.issued_location;
        this.user.id_card_date = new Date(
          this.userCollab.data.bank_account.id_card_date
        )
          .toISOString()
          .split("T")[0];
        this.user.account_number =
          this.userCollab.data.bank_account.account_number;
        if (this.userCollab.data.bank_account.front_side_image !== null) {
          this.user.front_side_image =
            process.env.VUE_APP_API_URL +
            this.userCollab.data.bank_account.front_side_image;
        }
        if (this.userCollab.data.bank_account.back_side_image !== null) {
          this.user.back_side_image =
            process.env.VUE_APP_API_URL +
            this.userCollab.data.bank_account.back_side_image;
        }
        this.user.bank_account_name =
          this.userCollab.data.bank_account.bank_name;
      }
      this.user.locations = this.userCollab.data.locations;
    },
    ...
    saveUser() {
      ...
      if (this.selectCities !== "") {
        userData["locations_ids"] = this.selectCities;
      }
      if (this.selectJobRoles !== "") {
        userData["job_role_ids"] = this.selectJobRoles;
      }
      if (this.selectJobLevels !== "") {
        userData["job_levels"] = this.selectJobLevels;
      }
      if (this.selectSkills !== "") {
        userData["candidate_skill_ids"] = this.selectSkills;
      }
      userData["proficient_language_ids"] = [];
      for (let language of this.user.proficient_languages) {
        userData["proficient_language_ids"].push(language._id);
      }
      userData["job_industries_ids"] = [];
      for (let industry of this.user.industries) {
        userData["job_industries_ids"].push(industry.id);
      }
      if (userData.id) {
        this.putProfileByCollaborator(userData);
      }
      this.isActiveEdit = false;
      this.isActiveEdit2 = false;
    },
    ...
    uploadBankImagesForCollaborator() {
      if (this.previewFrontImage !== null || this.previewBackImage !== null) {
        let front_side_image = null;
        let back_side_image = null;
        if (this.previewFrontImage !== null) {
          front_side_image = this.frontFile;
        }
        if (this.previewBackImage !== null) {
          back_side_image = this.backFile;
        }
        this.uploadBankImg({ front_side_image, back_side_image });
      } else {
        this.saveBankAccount();
      }
    },
    ...
    saveBankAccount() {
      ...
      const bankAccountData = {
        account_username: userStorage.data.id,
        bank_name: this.user.bank_account_name,
        account_number: this.user.account_number,
        bank_account_fullname: this.user.bank_account_fullname,
      };
      if (this.user.id_number !== null) {
        bankAccountData["id_number"] = this.user.id_number;
      }
      if (this.user.id_card_date !== "") {
        bankAccountData["id_card_date"] = new Date(
          this.user.id_card_date
        ).getTime();
      }
      if (this.user.issued_location !== null) {
        bankAccountData["issued_location"] = this.user.issued_location;
      }
      if (this.frontImagePath !== "") {
        bankAccountData["front_side_image"] = this.frontImagePath;
      }
      if (this.backImagePath !== "") {
        bankAccountData["back_side_image"] = this.backImagePath;
      }
      this.putBankAccount(bankAccountData);
      this.isActiveEdit3 = false;
    },

    pickIDCardFrontFile() {
      let input = this.$refs.fileFrontInput;
      let file = input.files;
      if (file && file[0]) {
        this.frontFile = file[0];
        let reader = new FileReader();
        reader.onload = (e) => {
    ...
    pickIDCardBackFile() {
      let input = this.$refs.fileBackInput;
      let file = input.files;
      if (file && file[0]) {
        this.backFile = file[0];
        let reader = new FileReader();
        reader.onload = (e) => {
          ...
          <b-tabs justified class="nav-tabs-custom">
                    ...
                    <div class="mat-action-form d-flex justify-content-end">
                      <div class="mat-button-form" v-if="isActiveEdit">
                        ...
                        <button
                          ...
                          v-on:click="uploadImgForCollaborator()"
                        >
                          Lưu
                        </button>
                      </div>
            ...
            <b-tab>
              <template v-slot:title>
                ...
                <span class="d-none d-sm-block">Hồ Sơ</span>
              </template>
              <div>
                <div class="col-12 mt-4">
                  <form class="form-horizontal mat-form-profile" role="form">
                    <div
                      class="
                        col-12
                        mat-form-profile-content mat-flex-layout-info
                        justify-content-end
                      "
                    >
                      <div
                        class="col-sm-12 col-xs-12 mat-form-profile-contents"
                      >
                        <b-form-group
                          id="example-view"
                          label-for="view"
                          class="mb-3 mat-form-group"
                        >
                          <span class="mat-form-title">
                            Vai trò công việc mà bạn rất hiểu
                          </span>
                          <multiselect
                            :disabled="!isActiveEdit2"
                            @input="inputValueJobRole"
                            v-model="user.job_roles"
                            :options="allJobRoles"
                            :multiple="true"
                            :taggable="true"
                            placeholder=""
                            ...
                            >{{ user.job_roles.name }}</multiselect
                          >
                        </b-form-group>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <span class="mat-form-title">
                            Cấp độ công việc mà bạn có thể giúp đỡ
                          </span>
                          <multiselect
                            :disabled="!isActiveEdit2"
                            @input="inputValueJobLevel"
                            v-model="user.job_levels"
                            :options="jobLevel"
                            :multiple="true"
                            :taggable="true"
                            :close-on-select="false"
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <span class="mat-form-title">
                            Ngành nghề mà bạn có kiến thức
                          </span>
                          <multiselect
                            :disabled="!isActiveEdit2"
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <span class="mat-form-title">
                            Các kỹ năng ứng viên hàng đầu bạn có thể đánh giá
                          </span>
                          <multiselect
                            :disabled="!isActiveEdit2"
                            @input="inputValueSkill"
                            v-model="user.candidate_skills"
                            :options="allSkills"
                            :multiple="true"
                            :taggable="true"
                            placeholder=""
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <span class="mat-form-title">
                            Ngôn ngữ mà bạn thành thạo
                          </span>
                          <multiselect
                            :disabled="!isActiveEdit2"
                            @input="inputValueLanguage"
                            v-model="user.proficient_languages"
                            ...
                            :close-on-select="false"
                            :clear-on-select="false"
                            >{{ user.proficient_languages.name }}</multiselect
                          >
                        </b-form-group>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      >
                        <span class="mat-form-title"> Địa điểm </span>
                        <multiselect
                          :disabled="!isActiveEdit2"
                    ...
                    <div class="mat-action-form d-flex justify-content-end">
                      <div class="mat-button-form" v-if="isActiveEdit2">
                        <button
                          type="button"
                          class="mat-button-cancel"
                          v-on:click="isActiveEdit2 = !isActiveEdit2"
                        >
                          Hủy
                        </button>
                        <button
            ...
            <b-tab>
              <template v-slot:title>
                ...
                <span class="d-none d-sm-block">Tài khoản ngân hàng</span>
              </template>
              <div class="col-12 mt-4">
                <form class="form-horizontal mat-form-profile" role="form">
                  <div class="mat-flex-layout">
                    <div
                      class="
                        col-lg-6 col-xl-6 col-md-6 col-sm-6 col-xs-12
                        mat-form-profile-content
                      "
                    >
                      <b-form-group
                        ...
                        label-for="about"
                      >
                        <span class="mat-form-title"> Tên ngân hàng </span>
                        <input
                          v-model="user.bank_account_name"
                          class="form-control"
                          :disabled="!isActiveEdit3"
                        />
                      </b-form-group>
                    </div>
                    <div
                    ...
                    >
                      <b-form-group
                        ...
                        class="mb-3 mat-form-group"
                      >
                        <span class="mat-form-title"> Số tài khoản </span>
                        <input
                  ...
                  <div class="mat-flex-layout">
                    ...
                    >
                      <b-form-group
                        ...
                        class="mb-3 mat-form-group"
                      >
                        <span class="mat-form-title"> Họ và Tên thẻ </span>
                        <input
                          v-model="user.bank_account_fullname"
                          id="reason"
                          type="area"
                          class="form-control"
                          :disabled="!isActiveEdit3"
                  ...
                  <div class="mat-flex-layout">
                    ...
                    >
                      <b-form-group
                        ...
                        class="mb-3 mat-form-group"
                      >
                        <span class="mat-form-title"> Ngày phát hành </span>
                        <input
                          v-model="user.id_card_date"
                          id="reason"
                          type="date"
                          class="form-control"
                          :disabled="!isActiveEdit3"
                    ...
                    >
                      <b-form-group
                        ...
                        class="mb-3 mat-form-group"
                      >
                        <span class="mat-form-title"> Nơi cấp </span>
                        <input
                          v-model="user.issued_location"
                          id="size"
                          type="text"
                          :disabled="!isActiveEdit3"
                          class="form-control"
                  ...
                  <div class="mat-flex-layout">
                    ...
                    >
                      ...
                      >
                        <span class="mat-form-title">
                          Mặt trước CMND/Thẻ căn cước
                        </span>
                        <div v-if="previewFrontImage !== null" class="identity-card__front">
                          <img
                            for="upLoadFront"
                        ...
                        <div
                          v-else-if="user.front_side_image !== null"
                          class="identity-card__front"
                        >
                          <img
                            for="upLoadFront"
                            :src="user.front_side_image"
                            alt=""
                          />
                        </div>
                        <div v-else class="identity-card__front">
                          <img
                            for="upLoadFront"
                            src="https://banner2.cleanpng.com/20180410/bbw/kisspng-avatar-user-medicine-surgery-patient-avatar-5acc9f7a7cb983.0104600115233596105109.jpg"
                            alt=""
                      ...
                      <div v-if="isActiveEdit3" class="identity-card__frontInput">
                        <input
                          ref="fileFrontInput"
                          type="file"
                          id="upLoadFront"
                          @input="pickIDCardFrontFile"
                          hidden
                        />

                        <label class="mat-button-upload" for="upLoadFront"
                          >Cập nhật ảnh</label
                        >
                      </div>
                    </div>
                    ...
                    >
                      ...
                      >
                        <span class="mat-form-title">
                          Mặt sau CMND/Thẻ căn cước
                        </span>
                        <div v-if="previewBackImage !== null" class="identity-card__back">
                          <img
                            for="upLoadBack"
                        ...
                        <div
                          v-else-if="user.back_side_image !== null"
                          class="identity-card__back"
                        >
                          <img
                            for="upLoadBack"
                            :src="user.back_side_image"
                            alt=""
                          />
                        </div>
                        <div v-else class="identity-card__back">
                          <img
                            for="upLoadBack"
                            src="https://banner2.cleanpng.com/20180410/bbw/kisspng-avatar-user-medicine-surgery-patient-avatar-5acc9f7a7cb983.0104600115233596105109.jpg"
                            alt=""
                      ...
                      <div v-if="isActiveEdit3" class="identity-card__backInput">
                        <input
                          ref="fileBackInput"
                          type="file"
                          id="upLoadBack"
                          @input="pickIDCardBackFile"
                          hidden
                        />

                        <label class="mat-button-upload" for="upLoadBack"
                          >Cập nhật ảnh</label
                        >
                      </div>
                    </div>
                  ...
                  <!-- <b-form-group
                    ...
                    class="mb-3"
                  >
                    <b-form-input id="knowledge" type="textarea"></b-form-input>
                  </b-form-group>
                  <b-form-group
                    id="example-facebook"
                    label="Nơi cấp "
                    ...
                    class="mb-3"
                  >
                    <b-form-input id="facebook" type="text"></b-form-input>
                  </b-form-group> -->
                  <div class="mat-action-form d-flex justify-content-end">
                    <div class="mat-button-form" v-if="isActiveEdit3">
                      <button
                        type="button"
                        class="mat-button-cancel"
                        v-on:click="isActiveEdit3 = !isActiveEdit3"
                      >
                        Hủy
                      </button>
                      <button
                        type="button"
                        class="mat-button-save"
                        v-on:click="uploadBankImagesForCollaborator()"
                      >
                        Lưu
                      </button>
                    </div>
