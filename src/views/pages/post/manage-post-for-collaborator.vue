...
export default {
  ...
  methods: {
    ...
    async searchPost() {
      // document.getElementById("demo-1").innerHTML = "search";
      ...
      this.searchPostsByCollaborator({
        keyword_type,
        keyword,
        companyId,
        cityId,
    ...
    changeSaveState(post_id, saved_post_id, e) {
      console.log(post_id);
      this.posts.forEach((post) => {
        if (post.id === post_id) {
          if (post.saved) {
            post.saved = false;
            this.unsavePost(saved_post_id);
          } else {
            post.saved = true;
    ...
    // changeActiveTab(tab) {
    //   let arrTab= document.querySelectorAll('.tabItem')
    //  arrTab.forEach((tab,index)=>{
    //    if(tab.classList.)
    //  })
    // },
    navigateToSavePostView() {
      this.$router.push({
...
<template>
  <Layout>
    <div class="mat-manage-post-collaborator">
      ...
      <div class="row pb-4">
        ...
        <div id="tab" class="d-flex flex-wrap">
          <div class="tabItem d-flex menuListColla">
            <i class="fas fa-briefcase"></i>
            <span>Tất cả công việc</span>
          </div>
          <div class="tabItem" v-on:click="navigateToSavePostView">
        ...
        <div class="col-12">
          <div class="filterAndJob-collaborator d-flex col-12">
            <div
            ...
            <div class="filterSelect">
              ...
              <div class="filterContent" style="width: 170px">
                <multiselect
                  v-model="type_work"
                  :options="type_works"
                  :allow-empty="false"
      ...
      <div class="col-12 d-flex">
        <div class="col-xl-8 col-12">
          ...
          <div class="mat-list-post">
            ...
            >
              <div
                class="mt-4 hovernow d-flex card__hovernow"
                ...
                <div class="body__hovernow d-flex mat-post-content">
                  <div class="col content__hovernow">
                    <div class="d-flex">
                      ...
                      <div class="urgency d-flex align-items-center">
                        <span
                          class="badge badgeStatus rounded-pill"
                          v-if="postValue.urgency === true"
                          >Tuyển gấp
                        </span>
                      </div>
                    </div>
                    ...
                    <div class="bottomCard">
                      <div class="row">
                        <div class="col-12 mat-bottom-card">
                          <div class="cardBottomItem col-sm-6 col-xs-12">
                  ...
                  <div class="col-auto save__hovernow">
                    <div v-on:click="changeSaveState(postValue.id, postValue.save_post_id)">
                      <i
                        v-if="postValue.saved"
...
.mat-manage-post-collaborator {
  ...
  .filterAndJob-collaborator .selectFilter {
    display: flex;
    justify-content: space-evenly;
  }
  .filterContent {
